                          ...
                          <div class="row">
                            ...
                            <div class="col-6 title text-center">
                                <h4  class="alert alert-primary text-center">
                                    {{ $reportTitle ?? __('main.sales_return_total_report') }}
                                </h4>
                                   ...
                                   style="text-align: center;direction: rtl;">
                                    ...
                                    @foreach($sales_return??[] as $sale_return)
                                        <tr>
                                            ...
                                            <td class="text-center">{{number_format(abs($sale_return->total_quantity), 3)}}</td>
                                            <td class="text-center">{{number_format($sale_return->round_net_total, 2)}}</td>
                                            <td class="text-center">{{number_format(round($sale_return->lines_total_after_discount, 2), 2)}}</td>
                                            <td class="text-center">{{number_format(round($sale_return->taxes_total, 2), 2)}}</td>  
                                        </tr>
