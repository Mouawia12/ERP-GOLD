                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <form method="POST" action="{{ route('purchase_return.store', ['id' => $invoice->id]) }}"
                                  enctype="multipart/form-data" id="purchase_return_form">
                                @csrf
                                <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <label style="float: right;">{{ __('main.bill_date') }}</label>
                                                        <input type="text" class="form-control" value="{{ $invoice->date }}" readonly />
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <label style="float: right;">{{ __('main.bill_number') }}</label>
                                                        <input type="text" value="{{ $invoice->bill_number }}" class="form-control" readonly />
                                                        <input type="hidden" value="{{ $invoice->bill_number }}" id="bill_id" name="bill_id" class="form-control" readonly />
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <label style="float: right;">{{ __('main.bill_client_name') }}</label>
                                                        <input type="text" name="bill_client_name" id="bill_client_name"
                                                               class="form-control"
                                                               value="{{ $invoice->customer?->name ?? $invoice->bill_client_name }}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="card mb-4">
                                                        ...
                                                        <div class="card-body px-0 pt-0 pb-2">
                                                            <div class="table-responsive p-0">
                                                                <table id="purchaseReturnTable" class="table items table-striped table-bordered table-condensed table-hover">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th class="text-center">
                                                                                <input class="form-control" id="checkAll" name="checkAll" type="checkbox">
                                                                            </th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                    @foreach($invoice->details()->whereNotIn('id', $invoice->returnInvoicesDetailsIds)->get() as $detail)
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center">{{ $detail->in_weight ?: $detail->out_weight }}</td>
                                                                            ...
                                                                            <td class="text-center">
                                                                                <input
                                                                                    ...
                                                                                    type="checkbox"
                                                                                    value="{{ $detail->id }}"
                                                                                    data-net-total="{{ round((float) $detail->net_total, 2) }}"
                                                                                >
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                                    ...
                                    <div class="card shadow mb-4 col-3">
                                        ...
                                        <div class="card-body">
                                            <div class="row" style="align-items: center; margin-bottom: 10px;">
                                                ...
                                                <div class="col-6">
                                                    <input type="text" readonly class="form-control" id="items_count" value="{{ count($invoice->details) }}">
                                                </div>
                                            </div>
                                            <div class="row" style="align-items: center; margin-bottom: 10px;">
                                                <div class="col-6">
                                            ...
                                            <div class="row" style="align-items: center; margin-bottom: 10px;">
                                                ...
                                                <div class="col-6">
                                                    <input type="text" readonly class="form-control" id="tax" name="tax" value="{{ $invoice->taxes_total ?? 0 }}">
                                                </div>
                                            </div>
                                            <div class="row" style="align-items: baseline; margin-bottom: 10px;">
                                                ...
                                                <div class="col-6">
                                                    <input type="text" readonly class="form-control" id="discount" name="discount" value="{{ $invoice->discount_total ?? 0 }}">
                                                </div>
                                            </div>
                                            <div class="row" style="align-items: center; margin-bottom: 10px;">
                                                <div class="col-6">
                                                ...
                                                <div class="col-6">
                                                    <input type="text" readonly class="form-control" id="purchase_net_total" value="{{ $invoice->net_total }}">
                                                </div>
                                            </div>
                                            <div class="row" style="align-items: center; margin-bottom: 10px;">
                                                <div class="col-6">
                                                    <label style="text-align: right;float: right;">صافي المردود المحدد</label>
                                                </div>
                                                <div class="col-6">
                                            ...
                                            <div class="alert alert-info py-2 px-3" style="font-size: 13px;">
                                                أدخل طريقة استلام رد المورد بحيث يساوي إجماليها صافي المردود المحدد فقط.
                                            </div>

                                            <div class="row" style="align-items: center; margin-bottom: 10px;">
                                                <div class="col-6">
                                                    <label style="text-align: right;float: right;">استلام نقدي</label>
                                                </div>
                                                <div class="col-6">
                                                    <input type="number" min="0" step="any" class="form-control" id="cash" name="cash" value="0">
                                                </div>
                                            </div>
                                            <div class="row" style="align-items: center; margin-bottom: 10px;">
                                                <div class="col-6">
                                                ...
                                                <div class="col-6">
                                                    <input type="text" readonly class="form-control" id="payment_remaining" value="0.00">
                                                </div>
                                            </div>

                                            @if ($bankAccounts->isEmpty())
                                                <div class="alert alert-warning py-2 px-3">
                                                    لا توجد حسابات بنكية نشطة على هذا الفرع. يمكن استلام المردود نقديًا فقط حاليًا.
                                                </div>
                                            @endif

                                            <div class="d-flex justify-content-between align-items-center mb-2 mt-3">
                                                <h6 class="mb-0">أسطر الاستلام غير النقدي</h6>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 text-center" style="display: block; margin: auto;">
                                                    <input type="button" class="btn btn-primary" id="return_btn"
                                                           tabindex="-1"
                                                           style="width: 150px; margin: 30px auto;" value="{{ __('main.return_bill') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('click', '#return_btn', function () {
            ...
            if (selectedRefundTotal <= 0) {
                alert('يجب اختيار صنف واحد على الأقل قبل حفظ مردود المشتريات');
                return;
            }

            if (Math.abs(paymentTotal - selectedRefundTotal) > 0.01) {
                alert('إجمالي استلام المردود يجب أن يساوي صافي المردود المحدد بالكامل');
                return;
            }

            document.getElementById('purchase_return_form').submit();
        });
    ...
    function buildRefundBankAccountOptions(methodType, selectedBankAccountId) {
        ...
        var filteredAccounts = (window.currentPurchaseReturnBankAccounts || []).filter(function (bankAccount) {
